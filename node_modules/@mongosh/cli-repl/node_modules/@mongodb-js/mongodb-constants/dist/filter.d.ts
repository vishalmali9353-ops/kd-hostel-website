export declare const ALL_CONSTANTS: ({
    ...
    readonly name: "$toArray";
    readonly value: "$toArray";
    readonly score: 1;
    readonly meta: "conv";
    ...
    readonly name: "$toObject";
    readonly value: "$toObject";
    readonly score: 1;
    readonly meta: "conv";
    readonly version: "8.3.0";
} | {
    ...
    readonly value: "$acos";
    readonly score: 1;
    readonly meta: "expr:trig";
    readonly version: "4.2.0";
} | {
    readonly name: "$acosh";
    readonly value: "$acosh";
    readonly score: 1;
    readonly meta: "expr:trig";
    readonly version: "4.2.0";
} | {
    ...
    readonly name: "$atan2";
    readonly value: "$atan2";
    readonly score: 1;
    readonly meta: "expr:trig";
    readonly version: "4.2.0";
} | {
    readonly name: "$atanh";
    readonly value: "$atanh";
    readonly score: 1;
    readonly meta: "expr:trig";
    readonly version: "4.2.0";
} | {
    ...
    readonly name: "$createObjectId";
    readonly value: "$createObjectId";
    readonly score: 1;
    readonly meta: "expr:misc";
    readonly version: "8.3.0";
} | {
    readonly name: "$createUUID";
    readonly value: "$createUUID";
    readonly score: 1;
    readonly meta: "expr:misc";
    readonly version: "8.3.0";
} | {
    readonly name: "$currentDate";
    readonly value: "$currentDate";
    readonly score: 1;
    ...
    readonly name: "$degreesToRadians";
    readonly value: "$degreesToRadians";
    readonly score: 1;
    readonly meta: "expr:trig";
    readonly version: "4.2.0";
} | {
    readonly name: "$deserializeEJSON";
    readonly value: "$deserializeEJSON";
    readonly score: 1;
    ...
    readonly name: "$hexHash";
    readonly value: "$hexHash";
    readonly score: 1;
    readonly meta: "expr:arith";
    readonly version: "8.3.0";
} | {
    ...
    readonly name: "$minMaxScaler";
    readonly value: "$minMaxScaler";
    readonly score: 1;
    readonly meta: "expr:arith";
    ...
    readonly name: "$radiansToDegrees";
    readonly value: "$radiansToDegrees";
    readonly score: 1;
    readonly meta: "expr:trig";
    readonly version: "4.2.0";
} | {
    ...
    readonly name: "$round";
    readonly value: "$round";
    readonly score: 1;
    readonly meta: "expr:arith";
    readonly version: "4.2.0";
} | {
    readonly name: "$sampleRate";
    readonly value: "$sampleRate";
    readonly score: 1;
    readonly meta: "expr:misc";
    readonly version: "4.4.2";
} | {
    ...
    readonly name: "$serializeEJSON";
    readonly value: "$serializeEJSON";
    readonly score: 1;
    readonly meta: "expr:type";
    readonly version: "8.3.0";
} | {
    ...
    readonly name: "$setField";
    readonly value: "$setField";
    readonly score: 1;
    readonly meta: "expr:obj";
    readonly version: "5.0.0";
} | {
    ...
    readonly name: "$sigmoid";
    readonly value: "$sigmoid";
    readonly score: 1;
    readonly meta: "expr:arith";
    readonly version: "8.2.0";
} | {
    ...
    readonly name: "$unsetField";
    readonly value: "$unsetField";
    readonly score: 1;
    readonly meta: "expr:obj";
    readonly version: "5.0.0";
} | {
    ...
    readonly value: "$changeStreamSplitLargeEvent";
    readonly label: "$changeStreamSplitLargeEvent";
    readonly outputStage: false;
    readonly fullScan: false;
    readonly firstStage: false;
    readonly score: 1;
    ...
    readonly apiVersions: readonly [1];
    readonly namespaces: readonly ["db"];
    readonly description: "Splits large change stream events that exceed 16MB into smaller fragments returned as separate events.";
    ...
    readonly value: "$listSearchIndexes";
    readonly label: "$listSearchIndexes";
    readonly outputStage: false;
    readonly fullScan: false;
    readonly firstStage: true;
    readonly score: 1;
    ...
    readonly description: "Returns information about existing Atlas Search and Atlas Vector Search indexes on a specified collection.";
    ...
    readonly value: "$rerank";
    readonly label: "$rerank";
    readonly outputStage: false;
    readonly fullScan: false;
    readonly firstStage: false;
    readonly score: 1;
    ...
    readonly apiVersions: readonly [];
    readonly namespaces: readonly ["coll"];
    readonly description: "Use MongoDB Voyage AI reranker models to refine the ranks of candidate documents and provide more accurate relevancy scores.";
    ...
    readonly apiVersions: readonly [];
    readonly namespaces: readonly ["coll"];
    readonly description: "Computes and returns a new score as metadata. It also optionally normalizes the input scores, by default to a range between zero and one.";
    ...
    readonly meta: "variable:system";
    readonly version: "8.3.0";
    readonly description: "A variable that references the index of the current array element in $map, $filter, and $reduce expressions. Use arrayIndexAs to specify a custom name instead.";
})[];
