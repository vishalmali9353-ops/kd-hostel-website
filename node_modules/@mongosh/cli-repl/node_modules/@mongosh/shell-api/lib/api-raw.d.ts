...
export declare class Shard<M extends GenericServerSideSchema = GenericServerSideSchema, D extends GenericDatabaseSchema = GenericDatabaseSchema> extends ShellApiWithMongoClass {
    ...
    listShards(filter?: Document_2): Promise<ShardInfo[]>;
    isConfigShardEnabled(): Promise<Document_2>;
    shardDrainingStatus(shardId?: string): Promise<Document_2>;
    getTransitionToDedicatedConfigServerStatus(): Promise<Document_2>;
}
