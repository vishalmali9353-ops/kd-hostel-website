...
export const ATLAS_VECTOR_SEARCH_AUTO_EMBED_TEMPLATE = mod.ATLAS_VECTOR_SEARCH_AUTO_EMBED_TEMPLATE;
...
export const VECTOR_SEARCH_AUTO_EMBED_STAGE = mod.VECTOR_SEARCH_AUTO_EMBED_STAGE;
