...
exports.VECTOR_SEARCH_AUTO_EMBED_STAGE = exports.REQUIRED_AS_FIRST_STAGE = exports.FULL_SCAN_STAGES = exports.OUT_STAGES = exports.STAGE_OPERATOR_NAMES = exports.STAGE_OPERATORS = void 0;
...
`,
  ...
  startAtOperationTime: \${7:time},
    ...
    },
    {
        ...
        apiVersions: [1],
        namespaces: [ns_1.DATABASE],
        description: 'Splits large change stream events that exceed 16MB into smaller fragments returned as separate events.',
        comment: `/**
...
`,
  ...
  users: [
    ...
    },
    {
        ...
        description: 'Returns information about existing Atlas Search and Atlas Vector Search indexes on a specified collection.',
        comment: `/**
...
`,
  ...
  newWith: \${1:replacementDocument}
    ...
    },
    {
        ...
        apiVersions: [],
        namespaces: [ns_1.COLLECTION],
        description: 'Use MongoDB Voyage AI reranker models to refine the ranks of candidate documents and provide more accurate relevancy scores.',
        comment: `/**
...
`,
  ...
  size: \${1:number}
    ...
    },
    {
        ...
        apiVersions: [],
        namespaces: [ns_1.COLLECTION],
        description: 'Computes and returns a new score as metadata. It also optionally normalizes the input scores, by default to a range between zero and one.',
        comment: `/**
...
const VECTOR_SEARCH_AUTO_EMBED_STAGE = {
    ...
    apiVersions: [],
    namespaces: [ns_1.COLLECTION, ns_1.VIEW],
    description: 'Performs a vector search (semantic search) over the specified field(s) which have a vector search index defined.',
    comment: `/**
...
exports.VECTOR_SEARCH_AUTO_EMBED_STAGE = VECTOR_SEARCH_AUTO_EMBED_STAGE;
