...
const SYSTEM_VARIABLES = [
    ...
    },
    {
        ...
        meta: 'variable:system',
        version: '8.3.0',
        description: 'A variable that references the index of the current array element in $map, $filter, and $reduce expressions. Use arrayIndexAs to specify a custom name instead.',
    },
];
