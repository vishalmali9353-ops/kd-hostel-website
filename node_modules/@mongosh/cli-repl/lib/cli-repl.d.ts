...
import { type OsInfo } from '@mongodb-js/get-os-info';
...
type CliUserConfigOnDisk = Partial<CliUserConfig> & Pick<CliUserConfig, 'enableTelemetry'>;
export declare class CliRepl implements MongoshIOProvider {
    ...
    setupTelemetrySink(): Promise<void>;
    setLoggingEnabled(enabled: boolean): Promise<void>;
    isTelemetryEnabled(): Promise<boolean>;
    setTelemetryEnabled(): Promise<void>;
