...
let Shard = (() => {
    ...
    let _shardDrainingStatus_decorators;
    let _getTransitionToDedicatedConfigServerStatus_decorators;
    var Shard = _classThis = class extends _classSuper {
        ...
        async listShards(filter) {
            (0, helpers_1.assertArgsDefinedType)([filter], [[undefined, 'object']], 'Shard.listShards');
            this._emitShardApiCall('listShards', { filter });
            await (0, helpers_1.getConfigDB)(this._database);
            const command = { listShards: 1 };
            if (filter) {
        ...
        async shardDrainingStatus(shardId) {
            (0, helpers_1.assertArgsDefinedType)([shardId], [[undefined, 'string']], 'Shard.shardDrainingStatus');
        ...
        async getTransitionToDedicatedConfigServerStatus() {
    ...
    (() => {
        ...
        _shardDrainingStatus_decorators = [(0, decorators_1.serverVersions)(['8.2.0', enums_1.ServerVersions.latest]), (0, decorators_1.apiVersions)([]), decorators_1.returnsPromise];
        _getTransitionToDedicatedConfigServerStatus_decorators = [(0, decorators_1.serverVersions)(['8.3.0', enums_1.ServerVersions.latest]), (0, decorators_1.apiVersions)([]), decorators_1.returnsPromise];
        ...
        __esDecorate(_classThis, null, _shardDrainingStatus_decorators, { kind: "method", name: "shardDrainingStatus", static: false, private: false, access: { has: obj => "shardDrainingStatus" in obj, get: obj => obj.shardDrainingStatus }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _getTransitionToDedicatedConfigServerStatus_decorators, { kind: "method", name: "getTransitionToDedicatedConfigServerStatus", static: false, private: false, access: { has: obj => "getTransitionToDedicatedConfigServerStatus" in obj, get: obj => obj.getTransitionToDedicatedConfigServerStatus }, metadata: _metadata }, null, _instanceExtraInitializers);
